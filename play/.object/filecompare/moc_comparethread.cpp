...
#include "../../FileCompare/comparethread.h"
...
QT_MOC_LITERAL(1, 5, 13), // "finishCompare"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "retlist"
QT_MOC_LITERAL(4, 28, 21) // "finishCompareToThread"

    },
    "Base\0finishCompare\0\0retlist\0"
    "finishCompareToThread"
};
...
void Base::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finishCompare((*reinterpret_cast< const QVariantList(*)>(_a[1]))); break;
        case 1: _t->finishCompareToThread((*reinterpret_cast< const QVariantList(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Base::*_t)(const QVariantList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Base::finishCompare)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Base::*_t)(const QVariantList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Base::finishCompareToThread)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Base::finishCompare(const QVariantList & _t1)
{
...
// SIGNAL 1
void Base::finishCompareToThread(const QVariantList & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
