...
QT_MOC_LITERAL(1, 7, 21), // "finish_compare_thread"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "retlist"
QT_MOC_LITERAL(4, 38, 16), // "startCompareSlot"
QT_MOC_LITERAL(5, 55, 4), // "hash"
QT_MOC_LITERAL(6, 60, 15), // "receiveBaseSlot"
QT_MOC_LITERAL(7, 76, 20) // "editStartCompareSlot"

    },
    "Thread\0finish_compare_thread\0\0retlist\0"
    "startCompareSlot\0hash\0receiveBaseSlot\0"
    "editStartCompareSlot"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finish_compare_thread((*reinterpret_cast< const QVariantList(*)>(_a[1]))); break;
        case 1: _t->startCompareSlot((*reinterpret_cast< const QVariantHash(*)>(_a[1]))); break;
        case 2: _t->receiveBaseSlot((*reinterpret_cast< const QVariantList(*)>(_a[1]))); break;
        case 3: _t->editStartCompareSlot((*reinterpret_cast< const QVariantHash(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Thread::*_t)(const QVariantList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::finish_compare_thread)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::finish_compare_thread(const QVariantList & _t1)
{
